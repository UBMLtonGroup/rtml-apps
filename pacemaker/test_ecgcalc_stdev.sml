...
in
    ...
    val expect = 5.237229365663818;
    val _ = (print "stdev expect: "; printr expect; print "\n");
    val _ = print "stdevl got: ";
    val s = Calcs.stdevl ([10.0, 12.0, 23.0, 23.0, 16.0, 23.0, 21.0, 16.0], 8.0);
    val _ = printr s;
    val _ = print "\n";
    val _ = assert (Real.== (expect, s)) "stdevl calc failed";
    
    val a = Array.fromList([10.0, 12.0, 23.0, 23.0, 16.0, 23.0, 21.0, 16.0])
    val s = Calcs.stdeva (a, 8.0)
    val _ = print "stdeva got: "
    val _ = printr s;
    val _ = print "\n";
    val _ = assert (Real.== (expect, s)) "stdeva calc failed";
